          ...
          <div className="row">
                    ...
                    >
                      <div className="accordion-body">
                        <div className="text">
                          ...
                          elit. Fusce nec ullamcorper justo. Sed facilisis, arcu
                          ut vestibulum tincidunt, ligula massa feugiat libero,
                          sit amet posuere elit magna non risus. Curabitur non
                          magna at augue tincidunt luctus et eget sapien.
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      <div className="accordion-body">
                        <div className="text">
                          ...
                          ultricies, urna at vestibulum ultrices, nisl massa
                          tristique nunc, ut varius lorem eros ac sapien.
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-lg-4 offset-lg-2">
              <div className="img wow">
                <img
                  src="/home1/assets/img/process.webp"
                  alt=""
                  className="img-cover"
                />
              </div>
