            ...
            <div className="col-lg-4">
              <div className="info-side">
                <div className="text fsz-24 color-333 lh-3 fw-600">
                  ...
                  Vivamus vitae orci euismod, fermentum risus at, eleifend
                  neque. Sed euismod purus vel nibh pretium, nec posuere nunc
                  lacinia.
                </div>
        ...
        <div className="foot">
          <div className="row">
            <div className="col-lg-6">
              <p className="fsz-13">© 2025 JATLink Labs. All Right Reserved</p>
            </div>
            <div className="col-lg-6">
