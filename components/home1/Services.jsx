  ...
  return (
    <section className="tc-services-style1">
            ...
            <div className="row">
              <div className="col-lg-3">
                ...
                >
                  ...
                  <div className="img">
                    <img
                      src="/home1/assets/img/services/ser1.webp"
                      alt=""
                      className="img-cover"
                    />
                  </div>
              ...
              <div className="col-lg-3">
                ...
                >
                  ...
                  <div className="img">
                    <img
                      src="/home1/assets/img/services/ser2.webp"
                      alt=""
                      className="img-cover"
                    />
                  </div>
              ...
              <div className="col-lg-3">
                ...
                >
                  ...
                  <div className="img">
                    <img
                      src="/home1/assets/img/services/ser4.webp"
                      alt=""
                      className="img-cover"
                    />
                  </div>
              ...
              <div className="col-lg-3">
                ...
                >
                  ...
                  <div className="img">
                    <img
                      src="/home1/assets/img/services/ser3.webp"
                      alt=""
                      className="img-cover"
                    />
                  </div>
      ...
      <div className="ser-img">
        <img src="/home1/assets/img/services/ser.webp" alt="" />
      </div>
    </section>
  );
}
