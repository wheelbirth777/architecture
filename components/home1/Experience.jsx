        ...
        <div className="row justify-content-between align-items-center">
          ...
          <div className="col-lg-3">
            <div className="info wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div className="text fsz-15 color-666">
                We are an architectural practice based in Boston, dedicated to
                designing and creating buildings that are both beautiful and
                sustainable.
              </div>
              <a
                href="#"
          ...
          <div className="col-lg-2">
            <div className="rotate-txt justify-content-lg-end">
              <ul>
                <li>
                  <a href="#"> support@studio.com </a>
                </li>
                <li>
                  <a href="#"> (074) 2222 11 57 </a>
                </li>
              </ul>
            </div>
          </div>
